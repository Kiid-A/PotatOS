...
const COLOR_READY: Rgb888 = Rgb888::new(0, 255, 0);    // green
const COLOR_RUNNING: Rgb888 = Rgb888::new(255, 0, 0);    // red
const COLOR_BLOCKED: Rgb888 = Rgb888::new(255, 255, 0);  // yellow
const COLOR_DEAD: Rgb888 = Rgb888::new(128, 128, 128);  // gray

const TIME_AXIS_HEIGHT: u32 = 40;       
const PROCESS_ROW_SPACING: u32 = 50;    
const SCALE_TEXT_Y_OFFSET: u32 = 20;    

struct ProcessVisualizer {
    disp: Display,
    block_size: u32,          // PCB size: pixle
    time_scale_pixel: u32,    
    base_x: u32,              
    base_y: u32,              
}
...
impl ProcessVisualizer {
    pub fn new() -> Self {
        Self {
            ...
            time_scale_pixel: 50,         
            base_x: 30,                   
            base_y: VIRTGPU_YRES - TIME_AXIS_HEIGHT, 
        }
    }
    ...
    fn calculate_optimal_scale(&self, time_span: u32, available_width: u32) -> u32 {
        let min_scale = 10;  // minimal time scale
